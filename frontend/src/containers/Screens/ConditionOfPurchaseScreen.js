            ...
            <Row>
                ...
                <Col lg={9} md={12} sm={12} xs={12}>
                    <Row className="breadcumber">
                        ...
                        <h6 className="breadcumber-box"><Link to="/conditions-of-purchase">Conditions of purchase</Link></h6>
                    </Row>
                </Col>
            </Row>
            <Row>
                ...
                <Col lg={9} className="top-margin">
                    <h3>General condition of purchase</h3>
                    <br />
...
export default ConditionOfPurchase;